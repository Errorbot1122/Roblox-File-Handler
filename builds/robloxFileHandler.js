var RBXFileHandler = (function (exports, xml2js, fs) {
	'use strict';
	...
	*/
	...
	const xmlParser = new xml2js__namespace.Parser();
	/**
	...
	*/
	...
	function fileToObject(path, callback) {
	  // Read the file
	  fs__namespace.readFile(path, (rErr, data) => {
	    if (rErr) {
	...
	exports.Color3uint8 = Color3uint8;
	exports.FormFactorPart = FormFactorPart;
	exports.GuiService = GuiService;
	exports.InputType = InputType;
	exports.Instance = Instance;
	exports.Material = Material;
	exports.Model = Model;
	exports.PVInstance = PVInstance;
	exports.Part = Part;
	exports.PartType = PartType;
	exports.RoClasses = RoClasses;
	exports.RoEnums = RoEnums;
	exports.RoModules = RoModules$1;
	exports.RoTypes = RoTypes;
	exports.SurfaceType = SurfaceType;
	exports.Terrain = Terrain;
	exports.Vector3 = Vector3;
	exports.Workspace = Workspace;
	exports._convertPropertyToType = _convertPropertyToType;
	exports.convertItemToInstance = convertItemToInstance;
	exports.convertValidInstance = convertValidInstance;
	exports.fileToObject = fileToObject;
	exports.findFirstItemByClassName = findFirstItemByClassName;
	exports.isItem = isItem;
	exports.isXMLTag = isXMLTag;
	exports.objToInst = objToInst;
